...
공개 범위를 따로 검토할 때는 [공개 베타 로컬 검토본 안내](beta/README.md)를 따릅니다. 이 정적 화면은 명시적으로 선별한 일부 항목만 사용하며 원본 파일 없이 실행할 수 있습니다. 선별 결정표와 실제 공개 후보 데이터는 Git 제외 로컬 폴더에만 있습니다. 외부 배포는 별도 최종 승인이 필요합니다.
